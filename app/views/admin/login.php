...
<head>
    ...
    <title>Login | CharityWorks</title>
    <meta name="description" content="Login to your CharityWorks account">
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="../home.view.php"><img src="assets/img/logo/logo.png" alt=""></a>
                                </div>
                            </div>
                                            ...
                                            <ul id="navigation">                                                                                          
                                                ...
                                                <li><a href="../Frontend/blog.html">Blog</a>
                                                    <ul class="submenu">
                                                        ...
                                                        <li><a href="../Frontend/blog_details.html">Blog Details</a></li>
                                                        <li><a href="../Frontend/elements.html">Element</a></li>
                                                    </ul>
                                                </li>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-contact contact_form" action="#" method="post" id="loginForm" novalidate="novalidate">
                            ...
                            <div class="form-group text-center mt-20">
                                <p>Don't have an account? <a href="../user/register.view.php" class="text-primary">Register now</a></p>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="single-footer-caption mb-30">
                                <div class="footer-tittle">
                                    <div class="footer-logo mb-20">
                                        <a href="../home.view.php"><img src="assets/img/logo/logo2_footer.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
