        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <form class="form-contact contact_form" enctype="multipart/form-data" action="/admin/campaign/update/<?php echo $campaign->id ?>"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input class="form-control" name="name" id="name" type="text"
                                           ...
                                           onblur="this.placeholder = 'Enter Campaign Name Here'"
