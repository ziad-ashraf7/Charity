                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="<?php echo '/admin/campaign/add?campaignId=' . $campaign->id ?>"><img
                                            width="50%"
                                ...
                                <div class="job-tittle">
                                    ...
                                    <a href="<?php echo \App\controllers\UserDonationController::BASE_ENDPOINT . '/make?campaignId='. $campaign->id ?>">
                                        <h4>Donate For</h4>
                                    </a>
